    ...
    <div class="hero-container" data-aos="fade-in">
        ...
        <div class="row" data-aos="fade-in">
            <section class="portfolio section-bg rounded-3 shadow">
                <div class="col-lg-12 mt-2 mt-lg-0 d-flex align-items-stretch justify-content-center"><div class="m-lg-5"><span class="black title center">Change PW</span></div></div>
                <div class="col-lg-12 mt-5 mt-lg-0 d-flex align-items-stretch justify-content-center">
                    <form action="http://3.34.217.193:포트/user-service/users/chgPw" method="post" role="form" class="php-email-form">
                        ...
                        <div class="text-center mt-2">
                            <br/>
                            <button type="submit" class="btn btnpoly white">비밀번호 변경</button>
                        </div>
                    </form>
                </div>
                <div class="text-end">
